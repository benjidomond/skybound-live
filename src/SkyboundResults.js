...
class SkyboundResults extends React.Component {
    ...
    async componentDidMount(){
        ...
        const [playerResponse, characterResponse, tagResponse, eventResponse] = await Promise.all([
            axios.get("https://skyboundarts.azurewebsites.net/api/players/"),
            axios.get("https://skyboundarts.azurewebsites.net/api/characters/"),
            axios.get("https://skyboundarts.azurewebsites.net/api/videotags/"),
            axios.get("https://skyboundarts.azurewebsites.net/api/events/")
        ]);
        this.setState({
    ...
    async searchOptions(playerName = "", characterName = "", eventName = ""){
        ...
        if (this.state.videoIDs.length === 0){
            var videoResponse = await axios.get(`https://skyboundarts.azurewebsites.net/api/videos/search/?playerName=${playerName}&characterName=${characterName}&eventName=${eventName}`);
            this.setState({
            ...
            videoResponse = await axios.get(`https://skyboundarts.azurewebsites.net/api/videos/search/?videoIDs=${this.state.videoIDs}&playerName=${playerName}&characterName=${characterName}&eventName=${eventName}`);
            this.setState({
                videos: Object.values(videoResponse.data)
            },
            () => {
    ...
    async tagSearch(){
        ...
        const tagSearchResponse = await axios.get(`https://skyboundarts.azurewebsites.net/api/mapvideotag/search/?searchTagID=${this.state.tagsQuery}`);
        this.setState({
    ...
    async findTagVideos(){
        ...
        const vidResponse = await axios.get(`https://skyboundarts.azurewebsites.net/api/videos/find/?videoIDs=${this.state.tempTags}`);
        this.setState({
    ...
    async findVideos(){
        ...
        const vidResponse = await axios.get(`https://skyboundarts.azurewebsites.net/api/videos/find/?videoIDs=${this.state.videoIDs}`);
        this.setState({
            videos: Object.values(vidResponse.data)
        },
        () => {
...
export default SkyboundResults;