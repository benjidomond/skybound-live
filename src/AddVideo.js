...
class AddVideo extends React.Component {
    ...
    async handleSubmit(e){
        ...
        */
        ...
        await axios.post("https://skyboundarts.azurewebsites.net/api/videos/", video)
        ...
        await axios.post("https://skyboundarts.azurewebsites.net/api/events/", event)
        .then(function (response){
            console.log(response);
        })
        .catch(function (error){
        ...
        await axios.post("https://skyboundarts.azurewebsites.net/api/players/", player1)
        .then(function (response){
            console.log(response);
        })
        .catch(function (error){
        ...
        await axios.post("https://skyboundarts.azurewebsites.net/api/players/", player2)
        .then(function (response){
            console.log(response);
            this.resetForm();
        })
